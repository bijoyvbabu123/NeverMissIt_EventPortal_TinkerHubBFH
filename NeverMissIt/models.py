...
class EventParticipants(models.Model):
    ...
    participants = models.TextField() # storing the participants names and is stored as a single string seperated by &.

    def __str__(self):
        return self.eventid.title + " (" + self.teamleader.username + ")" # shows the title and the team leader of the registered team, which is by default the User who is registering.